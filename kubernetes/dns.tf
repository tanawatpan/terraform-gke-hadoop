...
resource "google_compute_managed_ssl_certificate" "ssl_certificate" {
  ...
  managed {
    domains = [google_dns_record_set.jupyter.name, google_dns_record_set.spark_master.name, google_dns_record_set.spark_history.name, google_dns_record_set.namenode.name, google_dns_record_set.superset.name]
  }
}
